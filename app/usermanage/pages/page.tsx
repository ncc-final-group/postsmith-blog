        ...
        <div className="mb-4 flex flex-col items-start gap-4 border border-gray-300 bg-white p-4 sm:flex-row sm:items-center">
          ...
          <div className="ml-auto flex items-center gap-3">
            <div className="relative">
              ...
              />
              <button type="button" className="absolute right-2 top-1/2 -translate-y-1/2 transform rounded p-1 hover:bg-gray-100">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="mb-1 flex items-center gap-2">
                      ...
                      {post.privacy === 'private' && hoveredPostId !== post.id && <Lock className="absolute right-9 top-8 h-4 w-4 text-gray-400" />}
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        className={clsx(
                          ...
                          'hover:border-gray-400 focus:border-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-200',
                        )}
